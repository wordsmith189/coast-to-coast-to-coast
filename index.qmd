...
:::{.callout-tip appearance="simple"}
Download this figure [here](fig/fig-6.png).
:::
...
:::{.callout-tip appearance="simple"}
Download this figure [here](fig/fig-7.png).
:::
...
:::{.callout-tip appearance="simple"}
Download this figure [here](fig/fig-8.png).
:::
...
df_plot %>% 
  ...
  scale_color_grey(start=0.2, end=.9) +
...
:::{.callout-tip appearance="simple"}
Download this figure [here](fig/fig-9.png).
:::
