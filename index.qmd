...
p4 <- data_percent %>% 
  ...
  labs(title = "",
       ...
       caption = "Dollinger & Hinrichs (2026)"
       ) +
  theme_classic() +
  theme(plot.title.position = "plot",
        #plot.caption.position = "plot",
...
:::{.aside}
**Stefan**: (1) How can we improve the wording of the legend title? (2) The caption is wrong, isn't it? 
:::
...
include_graphics("fig/fig-15.png")
